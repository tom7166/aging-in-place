...
const NavBar: React.FC = () => {
  ...
  const searchableContent = [
    ...
    { title: 'Hardwood Flooring Buffalo NY', path: '/services/hardwood-flooring-Buffalo-ny', keywords: ['hardwood', 'flooring', 'buffalo', 'refinishing', 'installation'] },
    { title: 'Hardwood Floor Refinishing', path: '/services/hardwood-floor-refinishing', keywords: ['hardwood', 'floor', 'refinishing', 'refinish', 'restoration'] },
    { title: 'Buffalo Hardwood Floor Refinishing', path: '/services/hardwood-flooring/buffalo-hardwood-floor-refinishing', keywords: ['buffalo', 'hardwood', 'refinishing', 'floor', 'sanding'] },
    { title: 'Kenmore Hardwood Flooring Installation', path: '/services/hardwood-flooring/kenmore-hardwood-flooring-installation', keywords: ['kenmore', 'hardwood', 'installation', 'flooring'] },
    { title: 'Amherst Hardwood Floor Sanding', path: '/services/hardwood-flooring/amherst-hardwood-floor-sanding', keywords: ['amherst', 'hardwood', 'sanding', 'floor'] },
    { title: 'Tonawanda Hardwood Floor Repair', path: '/services/hardwood-flooring/tonawanda-hardwood-floor-repair', keywords: ['tonawanda', 'hardwood', 'repair', 'floor'] },
    { title: 'West Seneca Hardwood Flooring', path: '/services/hardwood-flooring/west-seneca-hardwood-flooring-contractor', keywords: ['west seneca', 'hardwood', 'flooring', 'contractor'] },
    { title: 'Buffalo Hardwood Floor Staining', path: '/services/hardwood-flooring/buffalo-hardwood-floor-staining', keywords: ['buffalo', 'hardwood', 'staining', 'floor', 'color'] },
    { title: 'Kenmore Floor Maintenance', path: '/services/hardwood-flooring/kenmore-hardwood-floor-maintenance', keywords: ['kenmore', 'floor', 'maintenance', 'care'] },
    { title: 'Amherst Engineered Hardwood', path: '/services/hardwood-flooring/amherst-engineered-hardwood-installation', keywords: ['amherst', 'engineered', 'hardwood', 'installation'] },
    { title: 'Tonawanda Refinishing Cost', path: '/services/hardwood-flooring/tonawanda-hardwood-floor-refinishing-cost', keywords: ['tonawanda', 'refinishing', 'cost', 'pricing'] },
    { title: 'West Seneca Floor Cleaning', path: '/services/hardwood-flooring/west-seneca-hardwood-floor-cleaning', keywords: ['west seneca', 'floor', 'cleaning', 'maintenance'] },
