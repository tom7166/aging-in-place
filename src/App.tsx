  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    <div className="bg-white shadow-lg rounded-lg p-6 border border-gray-200">
      <p className="text-md text-gray-700 mb-4">
        We would appreciate & encourage you using our bars on job leads we send you. 
        However, we understand that the timeframe for installation may require you to 
        source bars from a different provider. We do ask that if you install bars from 
        a different source, that you purchase an equal amount of bars from 
        GrabBars.com for your next install.
      </p>
