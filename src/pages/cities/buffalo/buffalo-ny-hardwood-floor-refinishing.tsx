...
import { Home as HomeIcon, ArrowRight, Phone, MapPin, CheckCircle, Star, Award, Shield, Sparkles, TreePine, Wrench } from 'lucide-react';
...
const BuffaloHardwoodRefinishing: React.FC = () => {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": `What's the difference between oil-based and water-based finishes in ${CITY}?`,
        "acceptedAnswer": {
          "@type": "Answer",
...
export default BuffaloHardwoodRefinishing;
