...
const NorthTonawandaWalkInTubInstallationPage = () => {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Walk-In Tub Installation North Tonawanda NY",
    "description": "Professional walk-in tub installation in North Tonawanda NY. Therapeutic walk-in tubs with safety features for Lumber City homes. Aging in place solutions throughout Western New York.",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "offers": {
      "@type": "Offer",
      "priceRange": "$7200-$15500",
      "priceCurrency": "USD"
    }
  };

  useEffect(() => {
    document.title = "Walk-In Tub Installation North Tonawanda NY | Therapeutic Tubs for Lumber City | Aaron Michael Services";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header/Hero Section */}
      <section className="bg-gradient-to-br from-blue-900 via-slate-800 to-gray-900 text-white relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                Walk-In Tub Installation <span className="text-blue-300">North Tonawanda NY</span>
              </h1>
              
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Professional walk-in tub installation in North Tonawanda NY with therapeutic walk-in tubs featuring safety doors and canal-appropriate finishes. 
                Aging in place solutions for Western New York's historic Lumber City community. 
                <strong className="text-white"> Safe, therapeutic bathing that complements Lumber City home character.</strong>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <button className="bg-blue-700 hover:bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors">
                  Free North Tonawanda Tub Consultation
                </button>
              </div>
            ...
            <div className="lg:pl-8">
              <div className="bg-white/10 backdrop-blur rounded-2xl p-6">
                <h3 className="text-2xl font-bold mb-4">Free North Tonawanda Walk-In Tub Assessment:</h3>
                <div className="space-y-3">
                  {[
                    "Lumber City bathroom space evaluation and planning",
                    "Walk-in tub model recommendations for canal-side homes", 
      ...
      <section className="bg-gradient-to-r from-slate-800 to-gray-900 text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Transform Your North Tonawanda Bathroom with Safe Walk-In Tub Installation
          </h2>
          <p className="text-xl mb-8 text-slate-100">
            Don't let bathing become a safety concern in your Lumber City home. 
            Our professional walk-in tub installation provides therapeutic bathing with complete safety features designed for canal-side living.
          </p>
...
export default NorthTonawandaWalkInTubInstallationPage;