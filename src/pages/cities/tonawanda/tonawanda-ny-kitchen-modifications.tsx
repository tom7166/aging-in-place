...
const TonawandaKitchenModificationsPage = () => {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Kitchen Modifications Tonawanda NY",
    "description": "Professional kitchen accessibility modifications in Tonawanda NY. Lowered counters, accessible cabinets, and universal design for aging in place in Twin Cities homes throughout Western New York.",
    "provider": {
      "@type": "LocalBusiness",
  ...
  useEffect(() => {
    document.title = "Kitchen Modifications Tonawanda NY | Accessible Kitchen Design for Twin Cities | Aaron Michael Services";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional kitchen accessibility modifications Tonawanda NY. Lowered counters, accessible cabinets, universal design for aging in place in Twin Cities homes. Call 716-533-7108.');
    }
    // Add canonical URL
    ...
    canonicalLink.setAttribute('href', 'https://aaronmichaelservices.com/tonawanda-ny-kitchen-modifications');
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                Kitchen Modifications <span className="text-orange-300">Tonawanda NY</span>
              </h1>
              
              <p className="text-xl mb-8 text-orange-100 leading-relaxed">
                Professional kitchen accessibility modifications in Tonawanda NY with lowered counters, accessible cabinets, and universal design. 
                Aging in place solutions for Twin Cities homes throughout Western New York's historic waterfront community. 
                <strong className="text-white"> Functional accessible kitchens that honor Twin Cities heritage.</strong>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <button className="bg-orange-700 hover:bg-orange-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors">
                  Free Tonawanda Kitchen Assessment
                </button>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    "Accessibility modification recommendations for waterfront properties", 
      ...
      <section className="bg-gradient-to-r from-orange-800 to-amber-900 text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Create the Heart of Accessible Living in Your Tonawanda Kitchen
          </h2>
          <p className="text-xl mb-8 text-orange-100">
            Don't let kitchen barriers limit your culinary independence in the beautiful Twin Cities. 
            Our kitchen modifications provide complete accessibility while maintaining the character that makes Tonawanda homes special.
          </p>
...
export default TonawandaKitchenModificationsPage;