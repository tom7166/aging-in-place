...
const RemodelingContractorAmherstPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHelmet
        title="Remodeling Contractor Amherst NY | Home Renovation Specialists | Aaron Michael Services"
        description="Expert remodeling contractors in Amherst NY. Kitchen, bathroom, basement, and whole-home renovations with accessibility features. Licensed, insured, educational community specialists. Call 716-533-7108."
        keywords="remodeling contractor Amherst NY, home renovation Amherst, general contractor Amherst, home improvement Amherst"
        canonicalUrl="https://aaronmichaelservices.com/remodeling-contractor-amherst-ny"
      />
      {/* Header/Hero Section */}
